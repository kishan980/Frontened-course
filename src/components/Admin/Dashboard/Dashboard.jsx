...
const Bar = ({ title, value, profit }) => (
  <Box py="4" px={['0', '20']}>
    ...
    <HStack width="full" alignItem={'center'}>
    ...
    >
      <Box boxSizing="border-box" py="16" px={['4', '0']}>
        ...
        >
          ...
          <DataBox title="User" qty={23} qtyPercentage={78} profit={true} />
          <DataBox
            title="Subscription"
            qty={12}
            qtyPercentage={20}
        ...
        <Grid templateColumns={['1fr', '2fr 1fr']}>
          <Box p="4">
            ...
            <Box>
              ...
              <Bar profit={true} title="Subscription" value={30} />
            </Box>
          </Box>
          <Box p={['0', '16']} boxSize="border-box" py="4">
            <Heading textAlign={'center'} size="md" mb="4" children="User" />
            <DoughnutChart />
          </Box>
        </Grid>
      </Box>
